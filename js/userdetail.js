...
const showUser = function (user) {
  console.log(user.voornaam)
	...
	let htmlString = `		<div class="c-detailuser">
  <div class="c-detailuser__welkomuser">
  <h1 class="c-detailuser__titel js-userdetailname">Hallo Tony Stark</h1>
  <p>Hoe voelt u zich vandaag ?</p>
</div>
  ...
  <div class="c-detailuser__tabcontent ">
    <div id="home" data-tab-content class="active c-detailuser__gebruikerkolomcontainer js-userdetails">
      <div class="c-detailuser__contactcontainer">
        <svg xmlns="http://www.w3.org/2000/svg" class="c-detailuser__contactsvg" width="34.1425" height="36.768" viewBox="0 0 68.285 73.536">
        ...
        <h2 class="c-detailuser__contacttitel">Contact informatie</h2>
      </div>
      ...
      <div class="c-detailuser__gebruikerkolomlast">
         <form action="" class="c-detailuser__detailform">
